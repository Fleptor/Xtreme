...
export const faqs = [
  ...
  ['htu', 'هل HTU بيوفّر لابتوبات، ولا لازم نجيب معنا؟', 'حسب تأكيد التنسيق المحلي، الاستضافة لا توفّر اللابتوبات؛ كل فريق مشارك في HTU لازم يحضر لابتوب واحد على الأقل. الحد الأدنى للفريق، وليس جهازًا لكل عضو. جهّزوا الجهاز، ولا تنسوا شاحنه.', 'htuDevices', 'تأكيد التنسيق المحلي للأجهزة'],
  ['htu', 'شو شروط المشاركة من HTU؟', 'كل الأعضاء طلبة جامعيون حاليون ومسجلون رسميًا عبر vTools، ويحضر جميعهم للموقع لمدة لا تقل عن 10 ساعات. حضور الافتتاح إلزامي لعضو واحد على الأقل من كل فريق، والاستثناء فقط للفريق المكوّن بالكامل من طالبات مع إكمال حضور جميع عضواته بحلول 8:00 صباحًا.', 'htuRules', 'تعليمات HTU المحلية'],
  ['htu', 'متى حفل الافتتاح في HTU؟', 'الساعة 12:00 منتصف الليل. حضور الافتتاح إلزامي لفرق HTU؛ يجب حضور عضو واحد على الأقل من كل فريق. فقط الفريق المكوّن بالكامل من طالبات يُسمح له بتجاوز الافتتاح للمشاركة، بشرط إكمال حضور جميع عضواته بحلول 8:00 صباحًا.', 'htuRules', 'تعليمات HTU المحلية'],
  ['htu', 'شو الاستثناء للفرق المؤلفة بالكامل من طالبات؟', 'الاستثناء الوحيد من حضور الافتتاح الإلزامي يخص الفريق المشارك في HTU والمكوّن بالكامل من طالبات: يُسمح لهذا الفريق فقط بتجاوز الافتتاح، بشرط إكمال تسجيل حضور جميع عضواته بحلول 8:00 صباحًا. الاستثناء يخص المشاركة ولا يشمل أهلية جوائز HTU.', 'htuRules', 'تعليمات HTU المحلية'],
  ['htu', 'هل استثناء الافتتاح يشمل الفريق المختلط؟', 'لا. حضور الافتتاح إلزامي للفريق المختلط ولأي فريق غير مكوّن بالكامل من طالبات؛ يجب أن يحضر عضو واحد منه على الأقل. الاستثناء فقط للفريق المكوّن بالكامل من طالبات والمشارك في HTU.', 'htuRules', 'تعليمات HTU المحلية'],
  ...
  ['community', 'كيف أتواصل مع سفير فرعي للاستفسار عن المسابقة؟', 'ابحث عن جامعتك في بطاقة اختيار السفير بقسم التسجيل لتعرف اسم سفير فرعك. بعدها تواصل معه عبر حسابات فرع IEEE في جامعتك، أو اطلب بيانات تواصله من إدارة الفرع. رقم السفير الظاهر في البطاقة مخصص للتسجيل على vTools.', 'ambassadorSelector', 'اعرف سفير فرعك'],
